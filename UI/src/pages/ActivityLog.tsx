  ...
  const fetchActivities = () => {
    ...
    const mockActivities: ActivityItem[] = [
      ...
      },
      {
        ...
        targetUrl: "#",
        comment:
          "I've double-checked the schema and it looks ready for the staging environment.",
        timestamp: "9:20 AM",
        badge: {
          type: "info",
          icon: "chat",
      ...
      },
      {
        ...
        user: {
          name: "System",
          avatar:
            "https://images.unsplash.com/photo-1518085901417-527c0ad04675?w=150",
        },
        ...
        <div className="max-w-3xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-slate-500">
              Real-time stream of updates from your team members.
            </p>
          </div>
          ...
          <div className="space-y-3">
            <label className="flex items-center gap-3 cursor-pointer group">
              <input
                ...
                onChange={(e) =>
                  handleFilterChange("comments", e.target.checked)
                }
            ...
            <label className="flex items-center gap-3 cursor-pointer group">
              <input
                ...
                onChange={(e) =>
                  handleFilterChange("statusChanges", e.target.checked)
                }
                className="rounded border-slate-300 text-blue-600 focus:ring-blue-600 h-4 w-4"
              />
              <span className="text-sm text-slate-600 group-hover:text-slate-900 transition-colors">
            ...
            <label className="flex items-center gap-3 cursor-pointer group">
              <input
                ...
                onChange={(e) =>
                  handleFilterChange("assignments", e.target.checked)
                }
                className="rounded border-slate-300 text-blue-600 focus:ring-blue-600 h-4 w-4"
              />
              <span className="text-sm text-slate-600 group-hover:text-slate-900 transition-colors">
            ...
            <label className="flex items-center gap-3 cursor-pointer group">
              <input
                ...
                onChange={(e) =>
                  handleFilterChange("attachments", e.target.checked)
                }
                className="rounded border-slate-300 text-blue-600 focus:ring-blue-600 h-4 w-4"
              />
              <span className="text-sm text-slate-600 group-hover:text-slate-900 transition-colors">
            ...
            {[
              ...
              >
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFilterChange("teamMember", e.target.value)
                  }
