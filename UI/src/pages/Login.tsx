    ...
    <div className="bg-gray-50 min-h-screen flex flex-col">
      ...
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-gray-200 px-6 py-3 bg-white">
        <div className="flex items-center gap-4 text-gray-900">
          ...
          <h2 className="text-lg font-bold leading-tight tracking-tight">Task Tracker</h2>
        </div>
        <Link to="/register" className="flex min-w-[84px] cursor-pointer items-center justify-center rounded-lg h-10 px-4 bg-blue-600 text-white text-sm font-bold leading-normal hover:bg-blue-700">
      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-[440px] bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          ...
          <div className="text-center mb-8">
            <h1 className="text-gray-900 tracking-tight text-[28px] font-bold leading-tight pb-2">Welcome back</h1>
            <p className="text-gray-600 text-sm font-normal">Enter your credentials to access your account</p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-2">
              <label className="text-gray-900 text-sm font-medium leading-normal">Email Address</label>
              <input 
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-center">
                ...
                <a className="text-blue-600 text-xs font-semibold hover:underline" href="#">Forgot password?</a>
              </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link className="text-blue-600 font-semibold hover:underline ml-1" to="/register">Sign up</Link>
            </p>
          </div>
        </div>
      </main>
