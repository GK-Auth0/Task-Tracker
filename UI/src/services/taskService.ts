...
export const taskService = {
  ...
  // Create new task
  createTask: async (data: CreateTaskRequest): Promise<{ success: boolean; data: Task }> => {
    const response = await api.post('/tasks', data);
    return response.data;
  },

  // Update task
  updateTask: async (id: string, data: Partial<CreateTaskRequest>): Promise<{ success: boolean; data: Task }> => {
